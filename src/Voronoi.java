...
public class Voronoi {
	...
	private ArrayList<Triangle> DelaunayTriangulation() throws FileNotFoundException {	
		...
		// discard extra 3 points
		System.out.println("--- Discarding Triangles ---");
		/*
		for (int k=0;k<T.size();) {
			Triangle temp = T.get(k);
			System.out.println("Considering " + temp);
			if (pointEquals(temp.a, p1)) {
				if (!pointEquals(temp.b, p2) && !pointEquals(temp.b, p3)) temp.a = temp.b;
				else if (!pointEquals(temp.c, p2) && !pointEquals(temp.c, p3)) temp.a = temp.c;
			}
			else if (pointEquals(temp.a, p2)) {
				if (!pointEquals(temp.b, p1) && !pointEquals(temp.b, p3)) temp.a = temp.b;
				else if (!pointEquals(temp.c, p1) && !pointEquals(temp.c, p3)) temp.a = temp.c;
			}
			else if (pointEquals(temp.a, p3)) {
				if (!pointEquals(temp.b, p1) && !pointEquals(temp.b, p2)) temp.a = temp.b;
				else if (!pointEquals(temp.c, p1) && !pointEquals(temp.c, p2)) temp.a = temp.c;
			}
			if (pointEquals(temp.b, p1)) {
				if (!pointEquals(temp.a, p2) && !pointEquals(temp.a, p3)) temp.b = temp.a;
				else if (!pointEquals(temp.c, p2) && !pointEquals(temp.c, p3)) temp.b = temp.c;
			}
			else if (pointEquals(temp.b, p2)) {
				if (!pointEquals(temp.a, p1) && !pointEquals(temp.a, p3)) temp.b = temp.a;
				else if (!pointEquals(temp.c, p1) && !pointEquals(temp.c, p3)) temp.b = temp.c;
			}
			else if (pointEquals(temp.b, p3)) {
				if (!pointEquals(temp.a, p2) && !pointEquals(temp.a, p1)) temp.b = temp.a;
				else if (!pointEquals(temp.c, p2) && !pointEquals(temp.c, p1)) temp.b = temp.c;
			}
			if (pointEquals(temp.c, p1)) {
				if (!pointEquals(temp.a, p2) && !pointEquals(temp.a, p3)) temp.c = temp.a;
				else if (!pointEquals(temp.b, p2) && !pointEquals(temp.b, p3)) temp.c = temp.b;
			}
			else if (pointEquals(temp.c, p2)) {
				if (!pointEquals(temp.a, p1) && !pointEquals(temp.a, p3)) temp.c = temp.a;
				else if (!pointEquals(temp.b, p1) && !pointEquals(temp.b, p3)) temp.c = temp.b;
			}
			else if (pointEquals(temp.c, p3)) {
				if (!pointEquals(temp.a, p2) && !pointEquals(temp.a, p1)) temp.c = temp.a;
				else if (!pointEquals(temp.b, p2) && !pointEquals(temp.b, p1)) temp.c = temp.b;
			}
